...
当视频属于讲解 / 科普 / 教程 / 解说 / 口播类时，`dialogue` 不是“配音文案”，而是**一个真实说话人正在对具体观众解决一个具体困惑**。

生成台词前必须先在内部完成以下判断：

1. **说话关系**：谁在说、对谁说、对方此刻最困惑或最容易误解什么。
   - 口播项目默认是固定主角在镜头前对一个具体观众说话，不要写成 AI 助手播报稿。
   - 如果 brief 里有目标人群，台词必须贴近该人群的真实语境。

2. **每句台词的口头动作**：每句话只承担一个动作，例如提醒、纠偏、安抚、给判断标准、给下一步。
   - 不要把一堆知识点压进一句话。
   - 15 秒 shot 通常只放 1 个主判断 + 1 个可执行做法，必须给画面、手势、产品特写和自然停顿留空间。

3. **把专业信息翻译成生活判断**：
   - 少用抽象名词堆叠，多用观众能立刻判断的身体感受、使用场景、动作步骤。
   - 例如不要只说“建立耐受”，应说“先一周两次，第二天不红、不刺，再考虑加频率”。

4. **保留真实口语节奏**：
   - 允许短句、停顿、转折、轻微不完整句。
   - 可以使用“先别急”“这一步很多人会错”“你记这个就行”这类自然口语。
   - 语气应像专业但亲近的人在当面解释，不像说明书、广告播报或 AI 总结。

5. **避免 AI 腔和模板腔**：
   - 默认不要使用这些表达：`今天带你快速了解`、`核心原则是`、`正确做法是`、`帮你解决什么问题`、`很多人不知道`、`少走弯路`、`首先/其次/最后`、`总的来说`、`长期坚持才更稳`。
   - 不要连续使用“科普、了解、核心、原则、解决、提升、打造、实现、赋能”等抽象词。
   - 不要把台词写成卖点清单、百科解释、公众号段落或短视频模板开场。

6. **口播质量自检**：
   - 这句话一个真人会不会自然说出口？
   - 观众听完这一句，是否知道下一步具体怎么做或怎么看？
   - 如果去掉画面，这句话是否仍然像人在说话，而不是 AI 在总结？
   - 如果答案是否定的，重写 `dialogue`。
...
8. 如果用户描述的是“讲解 / 旁白 / 解说 / 介绍”类视频，dialogue 应写成真人会自然说出口的中文口播台词，并按整段讲解逻辑拆分到合适的 shot 中
